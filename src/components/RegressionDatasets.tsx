    ...
    <div className="projects-container" id="regression">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <p style={{flex: 1, overflowY: 'auto', minHeight: '150px'}}>The EMG2POSE dataset consists of data from 193 participants, each performing 29 distinct hand gestures and movements. The dataset includes 32 channels of EMG data and 40 joint angle labels, enabling the evaluation of within-subject and cross-subject pose estimation.                </p>
            ...
            <div className="project">
                <h2>DS20: DS17-19: Hyser &nbsp;<a href={`${window.location.origin}/Hyser`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
                <p style={{flex: 1, overflowY: 'auto', minHeight: '150px'}}>The Hyser datasets consists of data from 20 participants, collected across two sessions, using a 256-channel high-density EMG system. The dataset includes three sub-datasets (1DOF, NDOF, Random) for evaluating regression models.                </p>
            ...
            <div className="project">
                ...
                <p style={{flex: 1, overflowY: 'auto', minHeight: '150px'}}>The User Compliance dataset consists of data from 6 participants, collecting 64-channel HD-EMG data from the forearm while performing 2 DoFs. The dataset explores user compliance with mimic training prompts, providing data for three emulated behaviors: baseline, anticipation, and all-or-nothing.                </p>
