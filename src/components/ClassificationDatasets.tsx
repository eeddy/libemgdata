...
function ClassificationDatasets() {
    ...
    <div className="projects-container" id="classification">
        ...
        <div className="projects-grid">
            ...
            <div className="project" style={{display: 'flex', flexDirection: 'column'}}>
                <h2>DS2: Electrode Shift &nbsp;<a href={`${window.location.origin}/ElectrodeShift`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS3: Minimal Training Data &nbsp;<a href={`${window.location.origin}/MinimalTrainingData`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS4: Weakly Supervised &nbsp;<a href={`${window.location.origin}/WeaklySupervised`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS5: Continuous Transitions &nbsp;<a href={`${window.location.origin}/ContinuousTransitions`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS6: Contraction Intensity &nbsp;<a href={`${window.location.origin}/ContractionIntensity`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS7: EMGEPN612 &nbsp;<a href={`${window.location.origin}/EMGEPN612`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS8: FORS-EMG &nbsp;<a href={`${window.location.origin}/FORSEMG`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS9: Limb Position (Fougner) &nbsp;<a href={`${window.location.origin}/LimbPosition`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS10: Cross-Session (GRABMyo) &nbsp;<a href={`${window.location.origin}/GRABMYO`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS11: High-Density (Hyser PR) &nbsp;<a href={`${window.location.origin}/Hyser`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS12: Single-User Multi-Day &nbsp;<a href={`${window.location.origin}/MultiDay`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS13: General (NinaPro DB2) &nbsp;<a href={`${window.location.origin}/NinaProDB2`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS14: Limb Position (Radmand) &nbsp;<a href={`${window.location.origin}/LimbPosition`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
            ...
            <div className="project">
                <h2>DS15: Pre/Post TMR (TMRShirleyRyanAbilityLab) &nbsp;<a href={`${window.location.origin}/TMR`} target="_blank" rel="noopener noreferrer"><DataIcon /></a></h2>
